      ...
      <div className="fixed inset-0 z-[100] flex items-start justify-center bg-black/90 pt-8">
        <div className="w-full max-w-[600px] mx-auto p-6">
          <div className="bg-[#1A1A1A] rounded-2xl p-6 shadow-lg border border-white/10">
            <h3 className="text-[length:calc(var(--text-scale)*28px)] font-[580] text-white tracking-tight mb-6">
            ...
            <form onSubmit={handleConnect}>
              {needsPassword && (
                <input
                  ...
                  className="w-full bg-white/10 rounded-xl px-6 py-4 text-[length:calc(var(--text-scale)*24px)] text-white placeholder-white/40 border border-white/10 mb-6 focus:outline-none"
                  autoFocus
                />
              )}

              {error && (
                <div className="text-red-500 text-[length:calc(var(--text-scale)*20px)] mb-6">{error}</div>
              )}
              ...
              <div className="flex justify-end gap-4">
                <button
                  ...
                  className="px-6 py-3 text-[length:calc(var(--text-scale)*24px)] font-[560] text-white/60 hover:text-white transition-colors"
                ...
                <button
                  ...
                  className="bg-white/10 hover:bg-white/20 transition-colors rounded-xl px-6 py-3 text-[length:calc(var(--text-scale)*24px)] font-[560] text-white disabled:opacity-50"
                >
